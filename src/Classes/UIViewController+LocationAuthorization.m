...
- (void)showLocationAlert:(NSString *)reason  {
    ...
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:NSLocalizedString(@"Location Authorization Needed", @"alarm pop-up title")
...
{
    return [UIViewController locationAuthorizedOrNotDeterminedBackgroundRequired:backgroundRequired viewController:nil];
}

- (bool)locationAuthorizedOrNotDeterminedAlertWithBackground:(bool)backgroundRequired
{
    return [UIViewController locationAuthorizedOrNotDeterminedBackgroundRequired:backgroundRequired viewController:self];
}


+ (bool)locationAuthorizedOrNotDeterminedBackgroundRequired:(bool)backgroundRequired viewController:(UIViewController *)controller {
