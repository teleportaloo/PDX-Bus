...
- (UITextField *)createTextField_Rounded {
    ...
    returnTextField.placeholder =
        NSLocalizedString(@"<enter stop ID>", @"default stop id text");
...
- (UITableViewCell *)tableView:(UITableView *)tableView
    ...
    case kRowEnter: {
        CellTextField *sourceCell = (CellTextField *)[tableView
        ...
        if (sourceCell == nil) {
            ...
            sourceCell.systemIcon = kSFIconEnterStopID;
            return sourceCell;
        }
    ...
    case kRowDone: {
        UITableViewCell *cell = [self tableView:tableView
                        cellWithReuseIdentifier:kDoneId];

        cell.textLabel.textAlignment = NSTextAlignmentLeft;
        // Set up the cell
        cell.textLabel.text =
            NSLocalizedString(@"Add this stop ID", @"action button");
