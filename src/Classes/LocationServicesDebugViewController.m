//
//  LocationServicesDebugViewController.m
//  PDX Bus
//
...
@interface LocationServicesDebugViewController ()

@end

@implementation LocationServicesDebugViewController
...
- (NSInteger)tableView:(UITableView *)tableView
    ...
    case kSectionText:
        return self.data.internalDataItems;
    }
    return 0;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView
    ...
    case kSectionText: {
        UITableViewCell *cell = [self tableView:self.table
               multiLineCellWithReuseIdentifier:MakeCellId(kSectionText)];

        cell.textLabel.text = [self.data internalData:(int)indexPath.row];
        // printf("width:  %f\n", cell.view.bounds.size.width);
        cell.selectionStyle = UITableViewCellSelectionStyleNone;
        // [self updateAccessibility:cell indexPath:indexPath text:[self.data
        // internalData:(int)indexPath.row] alwaysSaySection:YES];
    ...
    case kSectionMap: {
        UITableViewCell *cell = [self tableView:tableView
                        cellWithReuseIdentifier:MakeCellId(kSectionMap)];
        cell.textLabel.font =
