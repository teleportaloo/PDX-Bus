...
@property(nonatomic, copy, setter=setXml_waitingTime:)
    NSString *strWaitingTimeMins;
...
@property(nonatomic, copy, setter=setXml_startTime:)
...
@property(nonatomic, copy, setter=setXml_numberOfTransfers:)
    NSString *strNumberOfTransfers;
@property(nonatomic, readonly) NSInteger numberOfTransfers;
@property(nonatomic, copy, setter=setXml_numberOfTripLegs:)
    NSString *strNumberOfTripLegs;
@property(nonatomic, readonly) NSInteger numberOfTripLegs;
@property(nonatomic, copy, setter=setXml_walkingTime:)
    NSString *strWalkingTimeMins;
@property(nonatomic, readonly) NSInteger walkingTimeMins;
@property(nonatomic, copy, setter=setXml_transitTime:)
    NSString *strTransitTimeMins;
@property(nonatomic, readonly) NSInteger transitTimeMins;

@property(nonatomic, strong) NSMutableArray<TripLeg *> *legs;
@property(nonatomic, strong)
    NSMutableArray<TripLegEndPoint *> *displayEndPoints;
