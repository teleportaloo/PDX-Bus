...
- (void)test_XMLMultipleDepartures {
    ...
    sut.queryBlock = [XMLTestFile queryBlockWithFileForClass:@{@"XMLMultipleDepartures":@"arrivals-multiple-stops"}];
...
- (void)test_XMLDepartures {
    ...
    sut.queryBlock = [XMLTestFile queryBlockWithFileForClass:@{@"XMLDepartures":@"arrivals-single-stop"}];
    ...
    // Stop
    XCTAssertEqualObjects(  sut.locDesc,                    @"Fair Complex/Hillsboro Airport MAX Stn");
...
- (void)test_XMLDepartures_XMLStreetcarMessages_Streetcar {
    // Build
    XMLDepartures *sut =  [XMLDepartures xml];
    sut.queryBlock = [XMLTestFile queryBlockWithFileForClass:
    ...
    XCTAssertEqualObjects(  dep.fullSign,                   @"Portland Streetcar NS Line to South Waterfront");
...
- (void)test_XMLDepartures_errorMessage {
    // Build
    XMLDepartures *sut =  [XMLDepartures xml];
    sut.queryBlock = [XMLTestFile queryBlockWithFileForClass:@{@"XMLDepartures":@"arrivals-error-message"}];
