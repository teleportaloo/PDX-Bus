...
- (void)test_TriMetXML_queryTime {
    ...
    // Assert
    XCTAssert(tester.gotData);
    XCTAssertEqualWithAccuracy(tester.queryTime.timeIntervalSince1970,      date.timeIntervalSince1970, 0.001);
    XCTAssertNil(tester.parseError);
}

- (void)test_TriMetXML_XML_ATR_DATE {
    // Build
    XMLTestFile *xmlFile =  [XMLTestFile fileWithOneTag:XML_TEST_ATTRIBUTE_TAG attributes:@[@[@"item", @"56000"]]];
    XMLAttributeTester *tester = [XMLAttributeTester xml];
    ...
    XCTAssertEqualObjects(tester.nextItem, [NSDate dateWithTimeIntervalSince1970:56]);
...
- (void)test_TriMetXML_XML_XML_ATR_INT {
    // Build
    XMLTestFile *xmlFile =  [XMLTestFile fileWithOneTag:XML_TEST_ATTRIBUTE_TAG attributes:@[@[@"item", @"1"]]];
    XMLAttributeTester<NSString *> *tester = [XMLAttributeTester xml];
...
- (void)test_TriMetXML_XML_NON_NULL_ATR_STR {
    // Build
    XMLTestFile *xmlFile =  [XMLTestFile fileWithOneTag:XML_TEST_ATTRIBUTE_TAG attributes:@[@[@"item", @"hello"]]];
    XMLAttributeTester<NSString *> *tester = [XMLAttributeTester xml];
...
- (void)test_TriMet_XML_XML_NULLABLE_ATR_NUM {
    // Build
    XMLTestFile *xmlFile =  [XMLTestFile fileWithOneTag:XML_TEST_ATTRIBUTE_TAG attributes:@[@[@"item", @"456"]]];
    XMLAttributeTester *tester = [XMLAttributeTester xml];
...
- (void)test_TriMetXML_XML_ATR_TIME {
    // Build
    XMLTestFile *xmlFile =  [XMLTestFile fileWithOneTag:XML_TEST_ATTRIBUTE_TAG attributes:@[@[@"item", @"1234567890"]]];
    XMLAttributeTester<NSString *> *tester = [XMLAttributeTester xml];
...
- (void)test_TriMetXML_XML_ATR_BOOL_DEFAULT_FALSE {
    // Build
    XMLTestFile *xmlFile =  [XMLTestFile fileWithOneTag:XML_TEST_ATTRIBUTE_TAG attributes:
                             @[  @[@"item0", @"true"],
                                 @[@"item1", @"false"],
                                 @[@"item2", @"TRUE"],
                                 @[@"item3", @"FALSE"],
...
- (void)test_TriMetXML_XML_ATR_LOCATION {
    ...
    [xmlFile tagWithAtrributes:XML_TEST_ATTRIBUTE_TAG attributes:@[@[@"lat", @"-1.3141593141593"],   @[@"lng", @"2"]]];
    [xmlFile tagWithAtrributes:XML_TEST_ATTRIBUTE_TAG attributes:@[@[@"lat", @"1"]]];
    [xmlFile tagWithAtrributes:XML_TEST_ATTRIBUTE_TAG attributes:@[@[@"lng", @"1"]]];
    [xmlFile tagWithAtrributes:XML_TEST_ATTRIBUTE_TAG attributes:@[@[@"lat", @"45.479869999998"], @[@"lng", @"-122.70219199998"]]];
    [xmlFile tagWithAtrributes:XML_TEST_ATTRIBUTE_TAG attributes:@[@[@"what", @"1"]]];
    [xmlFile closeHeaderTag];
    ...
    XCTAssertEqualObjects(tester.nextItem, @"45.4798699999980,-122.7021919999800");
...
- (void)test_TriMetXML_XML_ATR_DISTANCE {
    // Build
    XMLTestFile *xmlFile =  [XMLTestFile fileWithOneTag:XML_TEST_ATTRIBUTE_TAG attributes:@[@[@"item", @"991234567890"]]];
    XMLAttributeTester<NSString *> *tester = [XMLAttributeTester xml];
...
- (void)test_TriMetXML_XML_ZERO_LEN_ATR_STR {
    // Build
    XMLTestFile *xmlFile =  [XMLTestFile fileWithOneTag:XML_TEST_ATTRIBUTE_TAG attributes:@[@[@"item", @"well hello dolly"]]];
    XMLAttributeTester<NSString *> *tester = [XMLAttributeTester xml];
...
- (void)test_NextWeekOverNewYearAnomoly {
    ...
    DEBUG_LOGS([NSDateFormatter localizedStringFromDate:date dateStyle:NSDateFormatterShortStyle timeStyle:NSDateFormatterMediumStyle]);
