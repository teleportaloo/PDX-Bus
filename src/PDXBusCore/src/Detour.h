...
#define STREETCAR_DETOUR_ID(X)                                                 \
    (((X) << DETOUR_ID_TAG_BITS) | STREETCAR_DETOUR_ID_TAG)
...
#define DETOUR_TYPE_FROM_ID(N)                                                 \
    (((N).integerValue & DETOUR_ID_TAG_MASK) == STREETCAR_DETOUR_ID_TAG        \
         ? @"Streetcar "                                                       \
         : @"")
