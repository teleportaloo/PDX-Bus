...
static const VEHICLE_INFO vehicleTypes[] =
{
    ...
    BUS_FLEET("2013",       "Gillig",       "Low Floor BRT",        "40", 3101, 3134 ),
    BUS_INFO1("2013",       "Gillig",       "Low Floor BRT",        "40", 3135, @" 🎉 1970's bus - #bTriMet 50th Birthday bus#b"),
    BUS_FLEET("2013",       "Gillig",       "Low Floor BRT",        "40", 3136, 3170 ),
    ...
    BUS_FLEET("2017",       "Gillig",       "Low Floor BRT",        "40", 3701, 3744 ),
    BUS_INFO1("2017",       "Gillig",       "Low Floor BRT",        "40", 3745, @"🏳️‍🌈 #ball are welcome#b 🏳️‍🌈"),
    BUS_FLEET("2017",       "Gillig",       "Low Floor BRT",        "40", 3746, 3757 ),
    BUS_FLEET("2018–19",    "New Flyer",    "Xcelsior CHARGE™ ⚡︎",   "40", 3801, 3805 ),
    BUS_FLEET("2018-19",    "Gillig",       "Low Floor BRT",        "40", 3901, 3964 ),
    BUS_FLEET("2019–20",    "Gillig",       "Low Floor BRT",        "40", 4001, 4071 )
};
...
+ (NSString *)vehicleString:(NSString *)vehicleId;
{
    ...
    {
        string =  [NSString stringWithFormat:@"Vehicle ID #U#b%@#b#D - #b#U%@#b#D\nMade by #U#b%@#b#D%@\nIntroduced #b#U%@#b#D%@",
                                          vehicleId,
                                          vehicle->type,
                                          vehicle->manufacturer,
                                          vehicle->model.length!=0 ? [NSString stringWithFormat:@"\nModel #U#b%@#b#D", vehicle->model] : @"",
                                          vehicle->first_used,
