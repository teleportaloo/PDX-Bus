...
@interface IASKAppSettingsViewController : AppSettingsCustomController <UITextFieldDelegate, UINavigationControllerDelegate, MFMailComposeViewControllerDelegate> {
